...
output_format = st.selectbox(
    "輸出格式", ["png", "jepg", "webp"], help="選擇圖像輸出格式"
)

background = st.selectbox(
    "背景選項", ["auto", "transparent"], help="透明背景只適用於 PNG 或 WebP格式"
)

if background == "transparent" and output_format == "jepg":
    st.warning("JEPG 格式不支援透明背景，請選擇PNG 或 WebP格式")
